...
mod pgm_layer_tests {
    ...
    //     random_values.sort();
    //     random_values.dedup();
    //     let entries: Vec<Entry<KType, Value>> = random_values
    //         .into_iter()
    //         .enumerate()
    ...
    //     let mut layer = MemoryPGMLayer::<KType, VType, EPSILON, Index>::empty();
    ...
    //     let mut layer = MemoryPGMLayer::<KType, Index, EPSILON, Index>::empty();
    ...
    //         let new_address = beneath.arena.insert(temp_node);
